...
const files = ['legacy.html', 'timer.html', 'manifest.json', 'service-worker.js'];
...
await writeFile('export/index.html', (await readFile('export/index.html', 'utf8')).replace('</head>', '<link rel="manifest" href="./manifest.json"></head>'));
...
hash.update(await readFile('export/index.html'));

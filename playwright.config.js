...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'firefox', testMatch: /(?:shell|compatibility|fallback|layout|m3|pll|recognition|oll|f2l|panels|sections|playback)\.spec\.js/, use: {
      browserName: 'firefox',
    ...
    { name: 'webkit', testMatch: /(?:shell|compatibility|fallback|layout|m3|pll|recognition|oll|f2l|panels|sections|playback)\.spec\.js/, use: { browserName: 'webkit' } },
  ],

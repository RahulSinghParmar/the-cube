...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'firefox', testMatch: /(?:shell|compatibility|fallback|layout|m3)\.spec\.js/, use: {
      browserName: 'firefox',
    ...
    { name: 'webkit', testMatch: /(?:shell|compatibility|fallback|layout|m3)\.spec\.js/, use: { browserName: 'webkit' } },
  ],
